...
public class PackageProductController : ApiBaseController
{
    ...
    {
        var gPackageProduct = await _packageProductService.Create(CurrentUserId, request);
    ...
    {
        var gPackageProduct = await _packageProductService.Delete(CurrentUserId,packageProductId);
        return gPackageProduct;
    }
    ...
    {
        var gPackageProduct = await _packageProductService.PackageProductById(CurrentUserId,packageProductId);
        return gPackageProduct;
    }
    ...
    {
        var gPackageProduct = await _packageProductService.PackageProducts(CurrentUserId, request);
        return gPackageProduct;
    }
    ...
    {
        var gPackageProduct = await _packageProductService.CreateDetail(CurrentUserId,packageProductId, request);
        return gPackageProduct;
    }
    ...
    {
        var gPackageProduct = await _packageProductService.UpdateDetail(CurrentUserId,packageProductId, productId,  request);
        return gPackageProduct;
    }
    ...
    {
        var gPackageProduct = await _packageProductService.DeleteDetail(CurrentUserId,packageProductId, productId);
        return gPackageProduct;
    }
    ...
    {
        var gPackageProduct = await _packageProductService.PackageProductDetailById(CurrentUserId,packageProductId, productId);
        return gPackageProduct;
    }
    ...
    {
        var gPackageProduct = await _packageProductService.PackageProductDetails(CurrentUserId,packageProductId,request);
        return gPackageProduct;
    }
}
